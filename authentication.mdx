...
description: Learn how Videograph secures all API access using environment‑scoped access tokens and secret keys.
---
...
<Steps>
  <Step title="Open your organization environment dashboard" titleType="p">
    
    Navigate to the environment where the API token will be used. All tokens are tied to this specific environment.

  </Step>

  <Step title="Create a new API access token" titleType="p">
  ...
  <Step title="Store credentials securely" titleType="p">
